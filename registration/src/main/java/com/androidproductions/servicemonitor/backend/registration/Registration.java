 ...
 * on 2014-04-30 at 14:49:56 UTC 
 * Modify at your own risk.
 */

package com.androidproductions.servicemonitor.backend.registration;

/**
 * Service definition for Registration (v1.2).
 *
 * <p>
 * This is an API
 * </p>
...
public class Registration extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "registration/v1.2/";
   ...
   * @return the request
   */
  public ListDevices listDevices() throws java.io.IOException {
    ListDevices result = new ListDevices();
    initialize(result);
    return result;
  }

  public class ListDevices extends RegistrationRequest<com.androidproductions.servicemonitor.backend.registration.model.CollectionResponseRegistrationRecord> {

    private static final String REST_PATH = "registrationrecord";
    ...
    protected ListDevices() {
      super(Registration.this, "GET", REST_PATH, null, com.androidproductions.servicemonitor.backend.registration.model.CollectionResponseRegistrationRecord.class);
    }
   ...
   *
   * @param content the {@link com.androidproductions.servicemonitor.backend.registration.model.RegistrationRecord}
   * @return the request
   */
  public Register register(com.androidproductions.servicemonitor.backend.registration.model.RegistrationRecord content) throws java.io.IOException {
  ...
  public class Register extends RegistrationRequest<Void> {
     ...
     * @since 1.13
     */
    protected Register(com.androidproductions.servicemonitor.backend.registration.model.RegistrationRecord content) {
