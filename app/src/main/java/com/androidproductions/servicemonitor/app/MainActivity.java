...
//import com.androidproductions.servicemonitor.backend.registration;
...
public class MainActivity extends DrawerActivity implements OnFragmentInteractionListener{
    ...
    private boolean checkPlayServices() {
        ...
        if (resultCode != ConnectionResult.SUCCESS) {
            if (GooglePlayServicesUtil.isUserRecoverableError(resultCode)) {
                ...
                Log.i("ServiceMonitor", "This device is not supported.");
                finish();
            }
            return false;
        }
    ...
    private String getRegistrationId(Context context) {
        ...
        if (registrationId.isEmpty()) {
            Log.i("ServiceMonitor", "Registration not found.");
            return "";
        }
        ...
        if (registeredVersion != currentVersion) {
            Log.i("ServiceMonitor", "App version changed.");
            return "";
        }
